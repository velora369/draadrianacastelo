      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-10 leading-relaxed animate-fade-in-up animation-delay-200">
          ...
          <div className="flex justify-center lg:justify-end animate-scale-in animation-delay-300">
            <div className="relative">
              ...
              <img 
                ...
                className="relative rounded-2xl shadow-xl w-full max-w-md lg:max-w-lg object-cover transition-transform duration-300 hover:scale-105"
              />
            </div>
          </div>
        </div>
